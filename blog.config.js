...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，这里是天用设计师的社区，欢迎来到我们的频道，了解我们',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Skyfusion', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '天用设计师', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://chinaiart.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'chinaiart, 广东天用，天用设计师，广州设计公司，vlog博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'wenjie@skyuse.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'link,wechat,qq,weibo,email,facebook,twitter', // 分享的服務，按顺序显示,逗号隔开
  // 所有支持的分享服务：link(复制链接),wechat(微信),qq,weibo(微博),email(邮件),facebook,twitter,messenger,whatsapp
